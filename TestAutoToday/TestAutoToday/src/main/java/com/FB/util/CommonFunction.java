...
public class CommonFunction extends com.FB.base.TestBase{
...
public void taponscreen() {
	@SuppressWarnings("rawtypes")
		...
		TouchAction touchaction = new TouchAction(driver);
		touchaction.press(PointOption.point(startx, starty)).moveTo((PointOption.point(startx, starty))).release().perform();
	}
