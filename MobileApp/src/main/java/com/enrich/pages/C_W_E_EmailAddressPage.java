...
public class C_W_E_EmailAddressPage extends TestBase{
	
	public C_W_E_EmailAddressPage() {
	...
	public String yourEmailAddressLabel()
	{
	MobileElement YOUREMAILADDRESS = ((AndroidDriver<MobileElement>)driver).findElementByAndroidUIAutomator("new UiSelector().text(\"What’s your mobile number?\")");
	String YOUREMAILADDRESSTEXT = YOUREMAILADDRESS.getText();
	return YOUREMAILADDRESSTEXT;
	}
	
	public String emailAddressLabel()
	{
	MobileElement EMAIlADDRESSLABEL = ((AndroidDriver<MobileElement>)driver).findElementByAndroidUIAutomator("new UiSelector().text(\"Email address\")");
	String EMAIlADDRESSLABELText = EMAIlADDRESSLABEL.getText();
	return EMAIlADDRESSLABELText;
	}
